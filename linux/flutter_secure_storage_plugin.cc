...
G_DEFINE_TYPE(FlutterSecureStoragePlugin, flutter_secure_storage_plugin, g_object_get_type())

// Called when a method call is received from Flutter.
static void flutter_secure_storage_plugin_handle_method_call(
    FlutterSecureStoragePlugin* self,
...
static void flutter_secure_storage_plugin_class_init(FlutterSecureStoragePluginClass* klass) {
  G_OBJECT_CLASS(klass)->dispose = flutter_secure_storage_plugin_dispose;
}

static void flutter_secure_storage_plugin_init(FlutterSecureStoragePlugin* self) {}
...
void flutter_secure_storage_plugin_register_with_registrar(FlPluginRegistrar* registrar) {
